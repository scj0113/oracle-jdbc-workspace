   ...
   */
   -- NEXTVAL를 한 번이라도 수행하지 않는 이상 CURRVAL를 가져올 수 없음!
   ...
   SELECT SEQ_EMPID.NEXTVAL FROM DUAL;  -- MAX값이 310이라 에러 발생!
   ...
   */
   ...
   SELECT SEQ_EMPID.NEXTVAL FROM DUAL;  -- 320    -- MAX값 변경되어 다시 증감
